...
class BaseModel(PydanticBaseModel):
    ...
    class Config:
        ...
        extra = Extra.forbid  # insert reason here
...
class Plan(BaseModel, ABC):
    ...
    def pre_copy(self) -> None:
        """Method invoked *before* copying the required OS installation files from
        the image to the drive. Empty by default.
        """

    def post_copy(self) -> None:
        """Method invoked *after* copying the required OS installation files from the
        image to the drive. Empty by default.
        """
